...
void AI::Update(int player2x, int player2y, int player2Width, int player2Height, int x, int y, int width, int height, bool canDodge, int vy, int doubleJump, int stageX0, int stageY0, int stageX1, int stageY1, float moveType)
{
	//Reset all inputs
	left = false;
	right = false;
	...
	if (!ShouldUseMove(player2x, player2y, player2Width, player2Height, x, y, width, height, doubleJump, moveType, stageX0, stageY0, stageX1, stageY1) && !(y > stageY0 || x < stageX0 || x > stageX1)) {
